...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 23-03-2025 a las 22:38:52
...
--
ALTER TABLE `clinica`
  MODIFY `clinica_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `orden`
  MODIFY `orden_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT de la tabla `pet`
--
ALTER TABLE `pet`
  MODIFY `pet_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
